...
$(function () {
    ...
    */
    describe('RSS Feeds', function () {
         ...
         */
        it('is URL defined and is not empty', function () {
         ...
         */
        it('is name defined and is not empty', function () {
            allFeeds.forEach(function (entry) {
    ...
    describe("the menu", function () {
        ...
        it("does menu change visibility", function () {
    ...
    describe("New Feed Selection", function () {
        ...
        beforeEach(function (done) {
            loadFeed(0, function () {
                newsFeed1 = $(".feed .entry").html();
                loadFeed(1, function () {
                    newsFeed2 = $(".feed .entry").html();
                    done();
                });
            });
        });

        it("should load second feed", function(){
            expect(newsFeed1).not.toEqual(newsFeed2);
        });
    });
